...
7. En estudios exploratorios y cualitativos con entrevistas semiestructuradas, la literatura ha documentado que la saturación puede alcanzarse entre 6 y 12 entrevistas, dependiendo del foco. Ver: Guest, G., Bunce, A., & Johnson, L. (2006). How many interviews are enough? An experiment with data saturation and variability. Field methods, 18(1), 59-82. [↑](#footnote-ref-7)
